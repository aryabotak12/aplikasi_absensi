...
public class DashboardMhs extends javax.swing.JFrame {
    ...
    private void getRekapMhs(){
       ...
       String query = " SELECT data_mahasiswa.nama, data_mahasiswa.nim, rekap.jmlh_hadir, rekap.jmlh_izin, rekap.jmlh_sakit, rekap.jmlh_alpa FROM data_mahasiswa data_mahasiswa JOIN rekap_absensi rekap ON data_mahasiswa.uid = rekap.uid WHERE data_mahasiswa.uid = ?";
